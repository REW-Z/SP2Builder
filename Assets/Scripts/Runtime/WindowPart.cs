...
public class WindowPart : Part, IFuselageCarver
{
	...
	// 按 Craft 级开关显示或隐藏 Window 线框预览网格。 / Show or hide this Window wire preview mesh using the craft-level toggle.
	...
	// 构建用于机身布尔切割的 Window 闭体 Mesh。 / Build the closed Window Mesh used for fuselage cutting booleans.
